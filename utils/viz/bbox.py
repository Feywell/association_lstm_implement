...
def plot_bbox(img, bboxes, scores=None, labels=None, thresh=0.5,
    ...
    labels : numpy.ndarray or  torch.Tensor, optional
...
def show_bbox(img, bboxes, fig, scores=None, labels=None, thresh=0.5,
              class_names=None, x=1, y=5, n=1, colors=None, ax=None,
              reverse_rgb=False, absolute_coordinates=True):
    """Visualize bounding boxes.
    ...
    ax = show_image(img, fig=fig, ax=ax, x=x, y=y, n=n, reverse_rgb=reverse_rgb)
