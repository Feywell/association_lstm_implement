...
class test_association(nn.Module):
    ...
    def forward(self, x):
        ...
        rois, loc, conf = output  # rois size: batchsize, top_k, 5 
        ...
        #plot_bbox(display_img, bboxes.cpu(), ax=ax2)
        plt.show()
...
def bulid_test_association_lstm(phase, cfg, size=300, num_classes=21):
    if phase != "test" and phase != "vid_test":
    ...
    return test_association(phase, cfg, size, base_, extras_, head_, num_classes)
